...
function Navbar() {
    ...
    const aboutMenu = [
        ...
        { title: "Vision Mission & Core Values", link: "/vision-mission-core-values" },
        { title: "Facilities", link: "/facilities" },
        { title: "School Structure", link: "/school-structure" },
        { title: "Mandatory Public Disclosure", link: "/Mandatory-public-disclosure" },
    ]
                        ...
                        <div className="flex md:block justify-between">
                            <Link to="/">
                                <div className="flex items-center  justify-between py-3 md:py-3 gap-4">
                                    ...
                                    <p className='text-2xl font-medium text-white hidden md:block'>Shri Guru Nanak Doon Vale School</p>
                                </div>
                            </Link>
