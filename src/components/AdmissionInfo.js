    ...
    return (
        <div className='bg-[#DBDBDB] mobilestyle'>
            <div className=' container mx-auto px-4 p-10 '>
                ...
                <div>
                    <p className='my-5'>The Common Aptitude Analysis is held in the third week of November at Shri Guru Nanak Doon Vale School at various locations in India. Additionally, it can be organised through the Indian Embassy there.</p>
                </div>
                <div>
