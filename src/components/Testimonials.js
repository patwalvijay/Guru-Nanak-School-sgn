...
const items = [
    <div onDragStart={handleDragStart}>
        ...
        <p className=' text-white  p-5 text-base text-justify  '> "My journey at S.G.N. Doon Vale School laid the foundation for who I am today. The values I learned, the support I received, and the friendships I made continue to guide me. I’m proud to be an alumnus of such a respected school in Dehradun."

        </p>
    </div>,
    <div onDragStart={handleDragStart}>
        <h2 className=' text-white font-bold text-3xl text-center uppercase'> Shraddha Singh </h2>
        <p className=' text-white  p-5 text-base text-justify  '> We’ve seen a remarkable transformation in our daughter since she joined Shri Guru Nanak Doon Vale School. The teachers are dedicated, the environment is safe, and the focus on values and discipline is exactly what we wanted. It truly is one of the best schools in Dehradun for overall development.
        </p>
    </div>,
    <div onDragStart={handleDragStart}>
        <h2 className=' text-white font-bold text-3xl text-center uppercase'> Trinetra Trivedi </h2>
        <p className=' text-white  p-5 text-base text-justify '> "I love my school! From interesting classes to fun house activities and events, every day is a new learning experience. My teachers always encourage me to do my best, and I feel confident to speak, participate, and grow. Doon Vale has become my second home.
