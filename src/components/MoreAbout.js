...
MAYO COLLEGE GIRLS’ SCHOOL */}
                        <h1 className="title-font sm:text-xl text-[20px] md:text-4xl mb-4 font-bold text-left mb-3">                   <span className='text-[#03001B]'> KNOW MORE ABOUT</span>
                            ...
                            <br className=" lg:inline-block" /><span className='text-white'>S.G.N DOON VALE SCHOOL</span>
  ...
  l11.547-1.2L16.026,0.6L20.388,10.918z"/>
                            ...
                            <p className="ml-2 text-lg font-medium text-white ">166 reviews</p>
                        </div>
                        <p className="mb-8 leading-relaxed text-white  text-justify">Welcome to Shri Guru Nanak Doon Vale School, one of the most trusted and respected co-educational schools in Dehradun since 1989. With a legacy of academic excellence and holistic development, we are dedicated to nurturing confident, responsible, and well-rounded individuals.

Our school offers structured education from Pre-Nursery to Class VIII, blending modern teaching methods with strong values and discipline. At S.G.N. Doon Vale, learning goes beyond the classroom, with a focus on creativity, leadership, and moral growth.

Students thrive in a safe, inclusive environment, supported by experienced educators and a vibrant house system that encourages healthy competition and teamwork. From engaging classroom sessions to enriching cultural activities, we ensure every child gets opportunities to grow and shine.

Located in the heart of the city, we are committed to providing quality education at accessible standards. If you're searching for the best school in Dehradun, we welcome you to visit our campus and experience the difference.
