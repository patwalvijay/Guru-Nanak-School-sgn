...
MAYO COLLEGE GIRLS’ SCHOOL */}
  ...
  l11.547-1.2L16.026,0.6L20.388,10.918z"
              ...
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="w-9 h-9 text-yellow-400 mx-1"
                xmlnsXlink="http://www.w3.org/1999/xlink"
                width="256px"
                height="256px"
                viewBox="0 0 32 32"
  ...
  l11.547-1.2L16.026,0.6L20.388,10.918z"
            ...
            <p className="mb-8 leading-relaxed text-white  text-justify">
              ...
              leadership, and moral growth. Students thrive in a safe, inclusive
          ...
          <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 ">
            <img
              className=" image1 moreabout object-cover object-center rounded"
              alt="hero"
              src="img/school_Vertical_2.JPG"
            />
