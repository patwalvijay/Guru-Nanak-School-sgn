                    ...
                    <div className='text-gray-600 body-font'>
                        <div className="container mx-auto flex px-5 py-52 md:flex-row flex-col items-center">
                            <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 ">
                                <h1 className="title-font sm:text-6xl text-5xl md:text-7xl mb-4 text-left  font-bold text-white hero___mobile">SHRI GURU NANAK DOON VALE
                                    <br className="hidden lg:inline-block" /> SCHOOL
                                </h1>
                                <p className="mb-8 leading-relaxed text-white text-2xl text-left">Know about S.G.N Doon Vale School</p>
                                <Link to="/our-history">
                                <div className=" ">
