        ...
        <div className="mx-auto w-full rounded-2xl  p-2">
            ...
            {({ open }) => (
              <>
                <Disclosure.Button className="flex w-full justify-between my-2  bg-white px-4 py-2 text-left text-sm font-medium text-black hover:bg-red-100 focus:outline-none focus-visible:ring focus-visible:ring-purple-500 focus-visible:ring-opacity-75">
                  <span> What classes does Shri Guru Nanak Doon Vale School offer?</span>
                  <ChevronUpIcon
                ...
                We offer structured education from Pre-Nursery to Class VIII in a co-educational environment. 
          ...
          <Disclosure>
            {({ open }) => (
              <>
                ...
                <h1 className=" font-bold">No, the school does not offer transportation services. Parents are requested to personally drop and pick up their children.
</h1>
          ...
          <Disclosure>
            {({ open }) => (
              <>
                <Disclosure.Button className="flex w-full justify-between my-2  bg-white px-4 py-2 text-left text-sm font-medium text-black hover:bg-red-100 focus:outline-none focus-visible:ring focus-visible:ring-purple-500 focus-visible:ring-opacity-75">
                  <span>What are the school timings?
</span>
                  <ChevronUpIcon
                    className={`${open ? 'rotate-180 transform' : ''
                      } h-5 w-5 text-black`}
                ...
                <Disclosure.Panel className="px-4 pt-4 pb-4 text-sm text-white bg-[#FFA700] ">
                <h1 className=" font-bold">School timings vary by class and season. Summer and winter timings are clearly communicated at the start of each term.</h1>
                {/* <ul className="list-decimal mx-8">
          ...
          <Disclosure>
            {({ open }) => (
              <>
                <Disclosure.Button className="flex w-full justify-between my-2  bg-white px-4 py-2 text-left text-sm font-medium text-black hover:bg-red-100 focus:outline-none focus-visible:ring focus-visible:ring-purple-500 focus-visible:ring-opacity-75">
                  <span>Does the school provide transport facilities?
                ...
                <Disclosure.Panel className="px-4 pt-4 pb-4 text-sm text-white bg-[#FFA700] ">
                No, the school does not offer transportation services. Parents are requested to personally drop and pick up their children.
          ...
          <Disclosure>
            {({ open }) => (
              <>
                <Disclosure.Button className="flex w-full justify-between my-2  bg-white px-4 py-2 text-left text-sm font-medium text-black hover:bg-red-100 focus:outline-none focus-visible:ring focus-visible:ring-purple-500 focus-visible:ring-opacity-75">
                  <span> What co-curricular activities are offered?
</span>
                  <ChevronUpIcon
                    className={`${open ? 'rotate-180 transform' : ''
                      } h-5 w-5 text-black`}
                ...
                <Disclosure.Panel className="px-4 pt-4 pb-4 text-sm text-white bg-[#FFA700] ">
                <h1 className=" font-bold">We offer a wide range of activities including dance, music, drawing, storytelling, cultural programs, and inter-house competitions.</h1>
