...
const Facilities = () => {
  const academicFacilities = [
    {
      ...
      description:
        "Spacious, well-lit, and furnished with age-appropriate seating.",
    },
    {
      icon: BookOpen,
      title: "Qualified Faculty",
      description:
        "Dedicated teachers who use activity-based and child-friendly teaching techniques.",
    },
    {
      icon: Mic,
      title: "English Language Focus",
      description:
        "Children are encouraged to converse in English to build confidence and fluency.",
    },
    {
      icon: BookOpen,
      title: "Library Access",
      description:
        "Books available for various age groups to promote reading habits (available at higher grades).",
    },
    {
      icon: Trophy,
      title: "Curriculum-Aligned Learning",
      description:
        "Following a structured curriculum designed to meet developmental needs at every stage.",
    },
  ];
  ...
  const SportsActivities = [
    "Annual Sports Meet: A grand celebration of athletic talent featuring track and field events, team games, and fun races",
    "Outdoor Sports: Cricket, football, volleyball, kho-kho, and athletics to promote teamwork, fitness, and competitive spirit",
    "Indoor Games: Chess, carrom, table tennis, and badminton to encourage strategic thinking and focus.",
    "Fitness & Training: Regular physical education classes, yoga sessions, and warm-up drills to enhance stamina, flexibility, and overall health",
  ];
    ...
    <>
      <Layout>
        <div className="min-h-screen bg-white">
          ...
          <Hero
            title={"Facilities"}
            icon={<Building2 className="w-12 h-12 mr-4 text-white" />}
          />
          {/* Content */}
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div className="mb-16 text-center">
              <p className="text-lg text-gray-700 leading-relaxed max-w-4xl mx-auto">
                At Shri Guru Nanak Doon Vale School, we believe that a
                well-rounded educational experience goes beyond textbooks. Our
                campus and infrastructure are thoughtfully designed to support
                both academic learning and the emotional, social, and creative
            ...
            <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="space-y-3 text-gray-700">
                  <div className="flex items-start">
                    ...
                    <p>
                      ...
                      sections from Pre-Nursery to Class VIII.
                    </p>
                  </div>
                  <div className="flex items-start">
                    <Clock className="w-5 h-5 text-[#990000] mr-3 flex-shrink-0 mt-0.5" />
                    <p>
                      Early finish timings for younger classes to ensure comfort
                      and attention span alignment.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-yellow-50 p-8 rounded-lg border border-yellow-200">
                ...
                <p className="text-gray-700 leading-relaxed">
                  The school does not provide transportation services. Parents
                  are encouraged to drop and pick up their children directly,
                  ensuring their safety and punctuality.
                </p>
              </div>
            </div>
          </div>
