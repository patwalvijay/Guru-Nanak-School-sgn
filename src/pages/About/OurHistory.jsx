        ...
        <div className="w-full max-w-3xl mx-auto text-center space-y-8">
          <p className="text-[#990000] text-2xl md:text-3xl font-semibold mb-4 text-center">
            ...
            <p className="text-lg leading-relaxed ">
              ...
              16th July 1989, marking the beginning of a visionary journey in
              education. The school’s roots trace back to a strong commitment
              to academic excellence, character building, and inclusive learning.
            </p>

            <p className="text-lg leading-relaxed">
              Our foundation stone was laid by Sant Baba Harbans Singh Ji,
              whose guidance and blessings gave shape to this noble initiative.
              The school was formally inaugurated by Hon'ble Shri N.D. Tewari,
              former Chief Minister of Uttar Pradesh, adding further significance
              and pride to our establishment.
            </p>

            <p className="text-lg leading-relaxed">
              What began as a humble institution has now evolved into one of the
              best schools in Dehradun, widely recognised for its consistent
              academic results, progressive teaching methods, and strong moral
              foundation. Over the years, S.G.N. Doon Vale School has educated
              thousands of students, shaping them into responsible, confident,
            ...
            <p className="text-lg leading-relaxed">
              ...
              living story of passion, perseverance, and progress that continues
