      ...
      <Layout>
        <div className="min-h-screen bg-white">
          ...
          <Hero
            ...
            icon={<Building className="w-12 h-12 mr-4 text-white" />}
          />
          {/* Content */}
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                  ...
                  >
                    <div className="flex items-start">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-[#990000] font-semibold mb-4">
                          {section.subtitle}
                        </p>
            ...
            <div>
              <div className="text-center mb-12">
                ...
                <h2 className="text-3xl font-bold text-[#990000] mb-4">
                  House System
                </h2>
                <p className="text-lg text-gray-700 leading-relaxed max-w-4xl mx-auto">
                  To promote leadership, discipline, teamwork, and healthy
                  competition, the school follows a Four-House System:
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
                {houses.map((house, index) => (
                  <div
                    key={index}
                    className={`${house.bgColor} ${house.borderColor} border-2 p-6 rounded-lg text-center`}
                  >
                    <Trophy
                      className={`w-12 h-12 mx-auto mb-4 ${house.textColor}`}
                    />
                    <h3 className={`text-xl font-bold ${house.textColor} mb-2`}>
                      {house.name}
                    </h3>
                    <p className={`${house.textColor} font-medium`}>
                      ({house.color})
                    </p>
                  </div>
                ))}
              ...
              <div className="bg-[#990000] text-white p-8 rounded-lg">
                <div className="text-center">
                  ...
                  <p className="leading-relaxed">
                    Each student is assigned to one of the houses and
                    participates in inter-house competitions, celebrations, and
                    school events throughout the academic year. This system
                    fosters a strong sense of identity and community spirit.
                  </p>
                </div>
              </div>
            </div>
